...
Put the package under your project folder in a directory named `readarr` and add the following to `Cargo.toml` under `[dependencies]`:
...
*CalendarFeedApi* | [**get_feed_v1_calendar_readarr_period_ics**](docs/CalendarFeedApi.md#get_feed_v1_calendar_readarr_period_ics) | **GET** /feed/v1/calendar/readarr.ics | 
