...
pub struct BookResourcePagingResource {
    ...
    pub records: Option<Option<Vec<models::BookResource>>>,
}

impl BookResourcePagingResource {
    pub fn new() -> BookResourcePagingResource {
