...
pub mod author_api;
pub mod author_editor_api;
pub mod author_lookup_api;
pub mod backup_api;
pub mod blocklist_api;
pub mod book_api;
pub mod book_editor_api;
pub mod book_file_api;
pub mod book_lookup_api;
pub mod bookshelf_api;
...
pub mod rename_book_api;
pub mod retag_book_api;
