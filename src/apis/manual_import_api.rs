...
pub async fn list_manual_import(configuration: &configuration::Configuration, folder: Option<&str>, download_id: Option<&str>, author_id: Option<i32>, filter_existing_files: Option<bool>, replace_existing_files: Option<bool>) -> Result<Vec<models::ManualImportResource>, Error<ListManualImportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
